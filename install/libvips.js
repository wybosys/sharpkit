...
const distBaseUrl = process.env.SHARP_DIST_BASE_URL || `https://coding.net/api/project/3753612/files/4342103/download?` || `https://github.com/lovell/sharp-libvips/releases/download/v${minimumLibvipsVersion}/`;
