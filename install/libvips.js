...
const distBaseUrl = process.env.SHARP_DIST_BASE_URL || `http://7xlcco.com1.z0.glb.clouddn.com/libvips/` || `https://github.com/lovell/sharp-libvips/releases/download/v${minimumLibvipsVersion}/`;
