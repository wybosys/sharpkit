...
const hasVendoredLibvips = function () {
  ...
  try {
    ...
    if (currentPlatformId === vendorPlatformId) {
      ...
      throw new Error(`'${vendorPlatformId}' binaries cannot be used on the '${currentPlatformId}' platform. Please remove the 'node_modules/sharpkit/vendor' directory and run 'npm install'.`);
    }
  } catch (err) {}
  return false;
};
